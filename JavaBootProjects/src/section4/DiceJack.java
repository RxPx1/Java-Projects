...
public class DiceJack {
	...
	public static void main(String[] args) {
		...
		if (num1 > 6 || num2 > 6 || num3 >6) {
			System.out.println("Numbers can not be greater than 6. Shutting game down...");
			System.exit(0);
		}
	...
	public static boolean checkWin(int sumDiceRolls, int sumOfNums) {
		return (sumOfNums > sumDiceRolls && sumOfNums - sumDiceRolls < 3);
	}
	}
